...
class Minotauro:
    def __init__(self, screen,pos, patrolRadius, minoType):
        self.screen = screen
        self.minotauroType = minoType
        self.name = ''
        self.renameTheMInotauroType()
        ...
        self.isMe = False
    def renameTheMInotauroType(self):
        if(self.minotauroType == 1):
            self.name = 'blue minotauro'
           
        elif(self.minotauroType == 2):
             self.name = 'brown minotauro'
