...
#        [self.allEnimys.append(cactus.addCactus(tile_rects, scroll)) for cactus in self.allCactus]
    ...
    def addingAllTheAnimys(self):
       ...
       # self.allCactus.append(Cactus(self.screen, 916))
        ...
        # cactus = []
        if(self.nivel == 0):
            self.allEnimys.append(Minotauro(self.screen, (1548, 168), 100))
            ...
            self.positions = [(1448, 168),(928, 184),(964, 184),(1448, 168),(1595, 168),(2370, 504),(2410, 504),(2450, 504),(2478, 504),(2718, 408)
